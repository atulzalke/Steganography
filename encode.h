...
///* get_bit *///
uint get_bit(const char byte, int bit); // ----> done
...
Status encode_data_to_image(char *data, int size, FILE *fptr_src_image, FILE *fptr_stego_image); // not needed

/* Encode a byte into LSB of image data array */
Status encode_byte_tolsb(char data, char *image_buffer); // replace with get_bit(char, int)
